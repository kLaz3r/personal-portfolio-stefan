...
import { getWebProjects } from "../lib/get-translated-project";
      ...
      <div className="container md:flex-row mx-auto flex flex-col items-start md:items-center justify-center min-h-[calc(100vh-5rem)]">
        ...
        >
          ...
          <h2 className="font-montserrat text-xl mr-12 md:max-w-md">
            {t("hero.description", {
              complex: t("hero.complex") as string,
              beautiful: t("hero.beautiful") as string,
          ...
          <div className="lg:w-1/2 flex flex-col items-start justify-center flex-grow space-y-6 relative">
            ...
            >
              <div>
                <h2
                  id="graphics-heading"
                  className="font-montserrat font-bold pt-4 md:pt-0 text-5xl md:text-6xl lg:text-7xl text-foreground mb-2"
                >
                  {t("graphics.title")}
                </h2>
              ...
              <motion.div
                ...
                role="list"
                aria-label={t("graphics.toolsLabel")}
              >
                {tools.map((tool) => (
                  <motion.div
                    key={tool}
                    ...
                    transition={{
                      ...
                      stiffness: 300,
                      damping: 20,
                      delay: 0.3 + tools.indexOf(tool) * 0.1,
                    }}
                  ...
                  >
                    <ToolIcon
                      toolName={tool}
                      className="w-9 h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 text-brand-primary"
                    />
                  </motion.div>
                ))}
              </motion.div>
...
const WebDevSection = () => {
  ...
  const projects = getWebProjects(language);
    ...
    >
      ...
      <div className="container mx-auto flex flex-col items-center md:items-center justify-center min-h-[calc(100vh-5rem)]">
        ...
        >
          <h2
            id="webdev-heading"
            className="text-center font-bold pb-2 text-7xl/14 md:text-8xl/20"
          >
            {t("webdev.title")}
          </h2>
          ...
          <div className="lg:w-1/2 flex flex-col items-start justify-center flex-grow space-y-6 relative">
            ...
            >
              <div>
                <h2
                  id="photos-heading"
                  className="font-montserrat font-bold text-5xl lg:text-7xl text-foreground mb-2"
                >
                  {t("photos.title")}
                </h2>
                <h3 className="font-montserrat text-xl md:text-2xl lg:text-3xl text-text-secondary">
    ...
    >
      <div className="container mx-auto flex w-full flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-5rem)] px-6 gap-12">
        ...
        >
          <h2
            id="about-heading"
            className="font-montserrat text-7xl pb-8 font-bold"
          >
            {t("about.title")}
          </h2>
          <p className="font-montserrat text-base text-justify">
            ...
            , Romania. I&apos;ve been into computers since I was 4, when my dad
            first introduced me to them — and I&apos;ve been hooked ever since.
            I started out learning how to fix problems, install programs, and
            make{" "}
            <span className="font-montserrat font-bold text-foreground">
              Windows
            </span>{" "}
            run smoother. <br />
            <br />
            Eventually, I got curious about{" "}
            <span className="font-montserrat font-bold text-foreground">
              Linux
            </span>{" "}
            and began using it as my daily OS, which opened up a whole new world
            of learning. In high school, I got into web development — starting
            ...
            , <span className="font-montserrat font-bold">InDesign</span>, and{" "}
            <span className="font-montserrat font-bold">CorelDRAW</span>. I
            learned how to turn creative ideas into high-quality printed
            materials on all kinds of surfaces. <br />
